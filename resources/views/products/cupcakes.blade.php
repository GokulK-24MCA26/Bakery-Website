                ...
                @foreach ($cupcakes as $cupcake)
                    <div class="col-6 col-md-3">
                        ...
                        <div class="card shadow h-100 border-0">
                            ...
                            @if ($cupcake->image)
                                <img src="{{ asset('storage/' . $cupcake->image) }}" class="card-img-top"
                            ...
                            <div class="card-body">
                                <h5 class="card-title mb-1">
                                    {{ preg_replace('/^[^a-zA-Z]+/', '', $cupcake->name) }}
                                </h5>
                                <p class="price mb-1">₹ {{ $cupcake->price }}</p>
                                <div class="d-flex align-items-center gap-2 mt-2">
                                    @auth
                                        <a href="{{ route('orders.create', $cupcake) }}"
