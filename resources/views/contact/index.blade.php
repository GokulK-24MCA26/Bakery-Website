                        ...
                        <div class="col-12">
                            <div class="info-card">
                                ...
                                <div>
                                    ...
                                    <div class="info-text">
                                        {{ $contactDetail->address_line1 ?? config('app.name') }},<br>
                                        {{ $contactDetail->address_line2 ?? 'Erode, Tamil Nadu' }}
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="info-card">
                                ...
                                <div>
                                    ...
                                    <div class="info-text">
                                        <a href="tel:{{ $contactDetail->phone_raw ?? '+91xxxxxxxxxx' }}">{{ $contactDetail->phone ?? '+91 xxxxx xxxxx' }}</a><br>
                                        <a href="{{ $contactDetail->whatsapp_url ?? '#' }}" target="_blank" rel="noopener">{{ $contactDetail->whatsapp_display ?? 'WhatsApp Us' }}</a>
                                        @if(!empty($contactDetail->email))
                                            <br><a href="mailto:{{ $contactDetail->email }}">{{ $contactDetail->email }}</a>
                                        @endif
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12">
                            <div class="info-card">
                                ...
                                <div>
                                    ...
                                    <div class="info-text">
                                        {{ $contactDetail->hours_weekday ?? 'Mon – Sat: 7:00 AM – 9:00 PM' }}<br>
                                        {{ $contactDetail->hours_sunday ?? 'Sunday: 8:00 AM – 6:00 PM' }}
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row g-3">
                                <div class="col-sm-6">
                                    <div class="cf-group">
                                        ...
                                        @error('name')
                                            <small style="color:#B23A48;">{{ $message }}</small>
                                        @enderror
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="cf-group">
                                        ...
                                        <select name="subject">
                                            ...
                                            <option value="order" {{ old('subject') == 'order' ? 'selected' : '' }}>Place
                                                an
                                                Order</option>
                                            <option value="custom" {{ old('subject') == 'custom' ? 'selected' : '' }}>Custom
                                                Cake</option>
    ...
    <section class="map-section">
        <div class="container">
            <div class="map-container">
                @if(!empty($contactDetail->map_embed_url))
                    <iframe src="{{ $contactDetail->map_embed_url }}" width="100%" height="350" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                @else
                    <div class="map-placeholder">
                        <i class="fa-solid fa-map-location-dot"></i>
                        <span>Map not configured — set it in Admin → Contact Details</span>
                    </div>
                @endif
            </div>
        </div>
